    ...
    <section id="contact" className="contact-section">
      <div className="contact-content">
        ...
        <div className="contact-items">
          <a href="https://www.linkedin.com/in/aniket-bhambhoriya-b4618a2a8?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="contact-item">
